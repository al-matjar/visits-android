...
data class AnimateMapToUserLocation(val userLocation: UserLocation, val map: HypertrackMapWrapper) : Effect()
data class DisplayUserLocation(val latLng: LatLng, val map: HypertrackMapWrapper) : Effect()
